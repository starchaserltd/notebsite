...
{ document.getElementById('config_price1').innerHTML=parseInt((cprice-cperr/2)*exch); document.getElementById('config_price2').innerHTML=parseInt((cprice+cperr/2)*exch); document.getElementById('dLabel').setAttribute('data-price',parseInt(cprice)); }
