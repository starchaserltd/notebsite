...
function amazon_com_link($prod,$keys)
{
	...
	return "https://www.amazon.com/gp/search?rh=n:13896617011,p_89:".$prod.",p_n_condition-type:6461716011&keywords=+".$keys."&ie=UTF8&".$rank."&low-price=150";
}
...
{
	$rank="s=price-asc-rank";
	return "https://www.amazon.de/gp/search/?fst=as:off&rh=n:427957031,p_n_condition-type:New,p_89:".$prod."&keywords=".$keys."&ie=UTF8&low-price=100&".$rank."";
}
