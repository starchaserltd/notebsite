...
?>
	...
	- A person or entity may request by email to <span class='contactEmail' onclick='mail_to("office");'></span> a referral tag or Noteb partner account. Similarly, a user may request an API key by email to <span class='contactEmail' onclick='mail_to("office");'></span> .<br>
	...
	- The requesting party is expected to print the contract, sign it and then email a scanned copy to <span class='contactEmail' onclick='mail_to("office");'></span> . <br>
	...
	If you learn that a user is not authorized to have a referral tag, partner account or API key or is otherwise violating this Agreement, we encourage you to contact Noteb at <span class='contactEmail' onclick='mail_to("office");'></span> with a description of the unauthorized activity. We may, in our sole discretion, determine whether and how to investigate or take action in respect of any such report. You agree you will not, without the prior written consent of Noteb.com, accuse any person or entity of being unauthorized or of violating this Agreement.
	</p>
	<br>
