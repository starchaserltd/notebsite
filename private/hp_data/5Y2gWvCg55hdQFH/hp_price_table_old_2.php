...
$table_columns["retailers"]=["hpcom"=>"HP Store","market_price"=>"Market Median","amazoncom"=>"Amazon US","newegg"=>"Newegg","bhphotovideo"=>"B&H Photo Video","bestbuyus"=>"Best Buy","tigerdirect"=>"TigerDirect","microcenter"=>"Microcenter"];
