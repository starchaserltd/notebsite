...
?>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><hr style="height:10px; width=:5px;"></div>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><hr style="height:5px; width=:50px;"></div>
					...
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 hiddenOptionsGpu">	
							...
							<select class="multisearch js-example-responsive" name="GPU_arch_id[]" id="GPU_arch_id" data-lcom='GPU_model' data-lfield="gpu_arch" data-placeholder="Ex. GCN 1.3, Pascal" data-initvalue="GPU Integrated" multiple="multiple" data-ajax--url="search/lib/func/list.php" style="width:100%;"></select>
						</div>
					</div>	
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">		
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="row">
					<hr class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="height:5px; width=:50px;">
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<div class="row">
					<hr class="col-xs-12 col-sm-6 col-md-6 col-lg-6"  style="height:5px; width=:50px;">
