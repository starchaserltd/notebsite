...
<div class="row headerback">
	<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12" style="background-color:white;padding:5px 10px">
...
<?php			
		...
		if($count > 0)
		{
			...
			?>
				<div class="orderByContainer col col-md-12 col-sm-6 col-xs-12 col-lg-8 col-xl-6">
					<a class="btn">Order by:</a>
		...
		<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-lg-4 col-xs-12 col-xl-3" style="padding-bottom: 30px;">
					<div class="searchresult">
						...
						<div class="btn btn-outline-secondary searchprice fakeBtn"><?php echo ""; echo $exchsign_model." ".$conf_price_text; ?></div>
