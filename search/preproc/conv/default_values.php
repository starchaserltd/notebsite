...
$sel="SELECT name,type FROM notebro_site.nomen WHERE type=8 OR type=11 OR type=12 OR type=25 OR type=26 OR type=51 OR type=52 OR type=53 OR type=54 OR type=55 OR type=56 ORDER BY `type`,`name` ASC";
