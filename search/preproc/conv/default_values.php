...
$sel="SELECT";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=17) AS cpu_lmin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=18) AS cpu_lmax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=13) AS cpu_coremin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=15) AS cpu_coremax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=14) AS cpu_freqmin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=16) AS cpu_freqmax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=19) AS cpu_techmin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=20) AS cpu_techmax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=21) AS cpu_tdpmin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=22) AS cpu_tdpmax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=27) AS gpu_memmin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=28) AS gpu_memmax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=29) AS gpu_membusmin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=30) AS gpu_membusmax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=31) AS display_sizemin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=32) AS display_sizemax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=33) AS hdd_capmin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=34) AS hdd_capmax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=35) AS mem_capmin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=36) AS mem_capmax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=37) AS mem_freqmin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=38) AS mem_freqmax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=39) AS acum_nrcmin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=40) AS acum_nrcmax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=41) AS acum_capmin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=42) AS acum_capmax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=43) AS chassisthicmin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=44) AS chassisthicmax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=45) AS chassiswidthmin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=46) AS chassiswidthmax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=47) AS chassisweightmin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=48) AS chassisweightmax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=49) AS chassisdepthmin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=50) AS chassisdepthmax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=57) AS waryearsmin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=58) AS waryearsmax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=59) AS batlifemin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=60) AS batlifemax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=61) AS gpu_power_min,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=62) AS gpu_power_max,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=63) AS chassis_web_min,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=64) AS chassis_web_max,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=65) AS display_hres_min,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=66) AS display_hres_max,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=67) AS display_vres_min,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=68) AS display_vres_max,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=72) AS list_cputech,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=73) AS list_gpumem,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=74) AS list_gpumembus,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=75) AS list_displaysize,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=76) AS list_memcap,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=77) AS list_memfreq,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=78) AS list_chassisweb,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=79) AS list_verres,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=80) AS gpu_lmin,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=81) AS gpu_lmax,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=83) AS list_hddsize,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=84) AS list_gputdp,";
$sel.=" (SELECT name FROM `".$GLOBALS['global_notebro_site']."`.nomen WHERE type=85) AS list_cputdp";
