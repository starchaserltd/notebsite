...
var quiz = {
        ...
        2:{
            ...
            'options': {
                ...
                'comm' : { 'txt':['<span style="font-size:13px;">video calls</span>','multiple'], 'img':['communication.svg',''], 'chk':{'on':[0],'style':['display:none;']},'no':1 },
...
if(locationPath == "/notebro/search/quiz/nquiz.php") {
        var getLinkAttribute = document.querySelector("link[href^=search]");  
        getHrefAttribute = getLinkAttribute.getAttribute('href');
         if(getHrefAttribute == "search/quiz/quiz.css") {
                getLinkAttribute.setAttribute("href", "quiz.css"); 
            }                                       

        var imgadd="res/img/icons/";       
