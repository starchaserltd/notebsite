...
{
	$sel_hdd="SELECT id,price,rating,err FROM `".$GLOBALS['global_notebro_db']."`.HDD WHERE 1=1 AND valid=1";
	...
	{ 
		$hdd_return[intval($rand[0])]=array("price"=>intval($rand[1]),"rating"=>intval($rand[2]),"err"=>intval($rand[3]));
	}
